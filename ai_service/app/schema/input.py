...
class UpdateProjectRequest(BaseModel):
    ...
    leadId: Optional[int] = Field(None, alias="leadId")
    ...
    permissionSchemeId: Optional[int] = Field(None, alias="permissionSchemeId")
    workflowSchemeId: Optional[int] = Field(None, alias="workflowSchemeId")
    issueTypeSchemeId: Optional[int] = Field(None, alias="issueTypeSchemeId")
    defaultAssigneeType: Optional[str] = Field(None, alias="defaultAssigneeType")
    defaultAssigneeId: Optional[int] = Field(None, alias="defaultAssigneeId")
